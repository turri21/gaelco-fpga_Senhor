...
//  para el datapath `thoop_video` (que ya está verificado pixel-exacto), las señales
...
module thoop_video_timing #(
    ...
    // coordenadas visibles para thoop_video (válidas cuando de=1)
