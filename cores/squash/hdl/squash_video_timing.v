// ============================================================================
//  Squash (Gaelco) — generador de TIMING de vídeo (FASE 1 / camino a HW).
//
//  Contadores H/V que barren la trama y producen: coordenadas visibles (hpos/vpos)
//  para el datapath `squash_video` (que ya está verificado pixel-exacto), las señales
...
module squash_video_timing #(
    ...
    // coordenadas visibles para squash_video (válidas cuando de=1)
