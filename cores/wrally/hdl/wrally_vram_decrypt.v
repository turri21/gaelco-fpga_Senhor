// ============================================================================
//  World Rally (Gaelco) — Descifrado de VRAM (gaelco_vram_encryption, gaelcrpt.cpp)
//
//  Funcion `decrypt(enc_prev, dec_prev, enc)` -> dec, COMBINACIONAL. params de
//  World Rally: P1=0x1f, P2=0x522a. La CPU escribe la VRAM CIFRADA; el vídeo la
//  lee DESCIFRADA. La cadena de 16/32 bits (stateful) se maneja fuera (por bus).
//
//  Traduccion 1:1 de gaelcrpt.cpp (ver sim/gaelco_decrypt_ref.h, la especificacion).
//  bitswap16: el 1er indice es el bit MSB (15) del resultado.
// ============================================================================
`default_nettype none

module wrally_vram_decrypt #(
    parameter [5:0]  P1 = 6'h1f,
    parameter [15:0] P2 = 16'h522a
) (
