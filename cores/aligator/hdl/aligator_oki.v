// ============================================================================
//  Thunder Hoop (Gaelco) — glue del OKI MSM6295 (jt6295) al mapa de samples.
//
//  Instancia jt6295 (INTERPOL=0) y traduce su `rom_addr` de 256 KB al espacio
//  REAL de samples de 1 MB de Thunder Hoop (`oki_map` de gaelco.cpp):
...
module aligator_oki (
    ...
    // --- ROM de samples de 1 MB (oki ROM) ---
...
`endif
    ...
    jt6295 #(.INTERPOL(0), .SAMPLE(0)) u_oki (
        ...
        .clk      ( clk         ),
        .cen      ( cen         ),
        .ss       ( 1'b1        ),          // PIN7_HIGH en Thunder Hoop
        .wrn      ( wrn         ),
        .din      ( din         ),
        .dout     ( dout        ),
        .rom_addr ( core_addr   ),
